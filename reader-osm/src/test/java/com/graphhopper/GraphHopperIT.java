...
public class GraphHopperIT {
        ...
        public static void beforeClass() {
                ...
                hopper = new GraphHopperOSM().setOSMFile(osmFile).setStoreOnFlush(true).setCHEnabled(false)
                                .setGraphHopperLocation(graphFileFoot)
                                .setEncodingManager(new EncodingManager(importVehicles)).importOrLoad();
        }
        ...
        public void testMonacoWithInstructions() throws Exception {
                GHResponse rsp = hopper.route(new GHRequest(43.727687, 7.418737, 43.74958, 7.436566).setAlgorithm(ASTAR)
        ...
        public void testAlternativeRoutes() {
                GHRequest req = new GHRequest(43.729057, 7.41251, 43.740298, 7.423561).setAlgorithm(ALT_ROUTE)
                                .setVehicle(vehicle).setWeighting(weightCalcStr);
        ...
        public void testAlternativeRoutesBikeAndCar() {
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(DIR + "/north-bayreuth.osm.gz")
                                .setCHEnabled(false).setGraphHopperLocation(tmpGraphFile)
                                .setEncodingManager(new EncodingManager("bike, car"));
                tmpHopper.importOrLoad();

                GHRequest req = new GHRequest(50.028917, 11.496506, 49.985228, 11.600876).setAlgorithm(ALT_ROUTE)
                ...
                req = new GHRequest(50.023513, 11.548862, 49.969441, 11.537876).setAlgorithm(ALT_ROUTE)
        ...
        public void testPointHint() {
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(DIR + "/Laufamholzstrasse.osm.xml")
                                .setCHEnabled(false).setGraphHopperLocation(tmpGraphFile)
                                .setEncodingManager(new EncodingManager("car"));
                tmpHopper.importOrLoad();

                GHRequest req = new GHRequest(49.46553, 11.154669, 49.465244, 11.152577).setVehicle("car")
        ...
        public void testNorthBayreuthDestination() {
                ...
                GHRequest req = new GHRequest(49.985307, 11.50628, 49.985731, 11.507465).setVehicle("car")
                                .setWeighting("fastest");
                ...
                req = new GHRequest(49.985307, 11.50628, 49.985731, 11.507465).setVehicle("generic")
                                .setWeighting("generic");
        ...
        public void testNorthBayreuthBlockeEdges() {
                ...
                GHRequest req = new GHRequest(49.985272, 11.506151, 49.986107, 11.507202).setVehicle("generic")
                                .setWeighting("generic");
                ...
                req = new GHRequest(49.975845, 11.522598, 50.026821, 11.497364).setVehicle("generic")
                                .setWeighting("generic");
                ...
                req = new GHRequest(50.009504, 11.490669, 50.024726, 11.496162).setVehicle("car")
                                .setWeighting("fastest");
                rsp = tmpHopper.route(req);
                assertFalse(rsp.getErrors().toString(), rsp.hasErrors());
        ...
        public void testMonacoVia() {
                GHResponse rsp = hopper.route(new GHRequest().addPoint(new GHPoint(43.727687, 7.418737))
                                .addPoint(new GHPoint(43.74958, 7.436566)).addPoint(new GHPoint(43.727687, 7.418737))
        ...
        public void testMonacoEnforcedDirection() {
                GHRequest req = new GHRequest().addPoint(new GHPoint(43.741069, 7.426854), 0.)
                                .addPoint(new GHPoint(43.744445, 7.429483), 190.).setVehicle(vehicle)
                                .setWeighting("fastest");
        ...
        public void testMonacoNonChMaxWaypointDistanceMultiplePoints() {
                ...
                GHRequest req = new GHRequest().addPoint(from).addPoint(via).addPoint(to).setVehicle(vehicle)
                                .setWeighting("fastest");
        ...
        public void testMonacoStraightVia() {
                GHRequest rq = new GHRequest().addPoint(new GHPoint(43.741069, 7.426854))
                                .addPoint(new GHPoint(43.740371, 7.426946)).addPoint(new GHPoint(43.740794, 7.427294))
                ...
                rq = new GHRequest().addPoint(new GHPoint(43.741069, 7.426854))
                                .addPoint(new GHPoint(43.741069, 7.426854)).addPoint(new GHPoint(43.740371, 7.426946))
                                .setVehicle(vehicle).setWeighting("fastest");
                rq.getHints().put(Routing.PASS_THROUGH, true);
                rsp = hopper.route(rq);
        ...
        public void testSRTMWithInstructions() throws Exception {
                ...
                assertEquals(new GPXEntry(43.727680946587874, 7.4191987684222065, 11.0, lastEntryMillis),
        ...
        public void testSRTMWithoutTunnelInterpolation() throws Exception {
                ...
                GHResponse rsp = tmpHopper.route(new GHRequest(43.74056471749763, 7.4299266210693755, 43.73790260334179,
                                7.427984089259056).setAlgorithm(ASTAR).setVehicle(vehicle).setWeighting(weightCalcStr));
                PathWrapper arsp = rsp.getBest();
        ...
        public void testKremsCyclewayInstructionsWithWayTypeInfo() {
                ...
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(tmpOsmFile).setStoreOnFlush(true)
                                .setCHEnabled(false).setGraphHopperLocation(tmpGraphFile)
                                .setEncodingManager(new EncodingManager(tmpImportVehicles)).importOrLoad();
        ...
        public void testRoundaboutInstructionsWithCH() {
                ...
                rsp = tmpHopper.route(new GHRequest(43.745968, 7.42907, 43.745832, 7.428614).setVehicle(tmpVehicle)
                                .setWeighting(tmpWeightCalcStr));
                arsp = rsp.getBest();
                assertEquals(2, ((RoundaboutInstruction) arsp.getInstructions().get(1)).getExitNumber());

                rsp = tmpHopper.route(new GHRequest(43.745948, 7.42914, 43.746173, 7.428834).setVehicle(tmpVehicle)
                                .setWeighting(tmpWeightCalcStr));
                arsp = rsp.getBest();
                assertEquals(1, ((RoundaboutInstruction) arsp.getInstructions().get(1)).getExitNumber());

                rsp = tmpHopper.route(new GHRequest(43.735817, 7.417096, 43.735666, 7.416587).setVehicle(tmpVehicle)
                                .setWeighting(tmpWeightCalcStr));
                arsp = rsp.getBest();
                assertEquals(2, ((RoundaboutInstruction) arsp.getInstructions().get(1)).getExitNumber());
        }
        ...
        public void testMultipleVehiclesWithCH() {
                ...
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(tmpOsmFile).setStoreOnFlush(true)
                                .setGraphHopperLocation(tmpGraphFile)
                                .setEncodingManager(new EncodingManager("bike,car")).importOrLoad();
                ...
                tmpHopper = new GraphHopperOSM().setOSMFile(tmpOsmFile).setStoreOnFlush(true)
                                .setGraphHopperLocation(tmpGraphFile)
                                .setEncodingManager(new EncodingManager("car,bike")).importOrLoad();
        ...
        private void checkMultiVehiclesWithCH(GraphHopper tmpHopper) {
                ...
                GHResponse rsp = tmpHopper
                                .route(new GHRequest(43.73005, 7.415707, 43.741522, 7.42826).setVehicle("car"));
                PathWrapper arsp = rsp.getBest();
                ...
                GHRequest req = new GHRequest().addPoint(new GHPoint(43.741069, 7.426854), 0.)
                                .addPoint(new GHPoint(43.744445, 7.429483), 190.).setVehicle("bike")
                                .setWeighting("fastest");
        ...
        private void executeCHFootRoute() {
                ...
                GHResponse rsp = tmpHopper
                                .route(new GHRequest(43.727687, 7.418737, 43.74958, 7.436566).setVehicle(vehicle));
        ...
        public void testRoundTour() {
                GHRequest rq = new GHRequest().addPoint(new GHPoint(43.741069, 7.426854)).setVehicle(vehicle)
                                .setWeighting("fastest").setAlgorithm(ROUND_TRIP);
        ...
        public void testFlexMode_631() {
                ...
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(tmpOsmFile).setStoreOnFlush(true)
                                .setGraphHopperLocation(tmpGraphFile).setEncodingManager(new EncodingManager("car"));

                tmpHopper.getCHFactoryDecorator().setEnabled(true).setWeightingsAsStrings(Arrays.asList("fastest"))
                                .setDisablingAllowed(true);

                tmpHopper.getLMFactoryDecorator().setEnabled(true).setWeightingsAsStrings(Arrays.asList("fastest"))
                                .setDisablingAllowed(true);
                ...
                assertTrue("Visited nodes for hybrid mode should be different to CH but " + hSum + "==" + chSum,
                                hSum != chSum);
        ...
        public void testTurnCostsOnOff() {
                GraphHopper tmpHopper = new GraphHopperOSM().setOSMFile(DIR + "/moscow.osm.gz").setStoreOnFlush(true)
                                .setCHEnabled(false).setGraphHopperLocation(tmpGraphFile)
